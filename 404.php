        ...
        <div class="container px-6 py-12 mx-auto lg:flex lg:items-center lg:gap-12">
            <div class="w-full lg:w-1/2">
                ...
                <div class="flex items-center mt-6 gap-x-3">
                    ...
                    <!-- Home Button -->
                    <a href="https://google.com" class="w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-blue-500 rounded-lg shrink-0 sm:w-auto hover:bg-blue-600 dark:hover:bg-blue-500 dark:bg-blue-600">
                        Take me home
                    </a>
                </div>
            </div>
