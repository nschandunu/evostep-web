<html lang="en">
  <head>
    ...
    <title>Explore Page - EvoSteps</title>
  ...
  <body>
    ...
    <div
      ...
      style="background-image: url('../../assets/images/blog1.png')"
    >
      ...
      >
        ...
        <p class="text-white text-base md:text-2xl text-center font-nunito">
          We are EvoStep, we create footwear that combines style and comfort.
        </p>
      </div>
    </div>
    ...
    <div class="container mx-auto p-4">
      ...
      <div
        ...
        style="background-image: url('../../assets/images/blog2.png')"
      >
        <div class="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 rounded-lg">
          <div
            class="bg-white bg-opacity-90 w-11/12 md:w-[40rem] h-auto md:h-[21.5rem] backdrop-blur-lg p-6 rounded-lg flex flex-col justify-center shadow-lg"
          >
            <div class="text-center text-sm md:text-lg font-nunito text-gray-800 leading-relaxed mb-4">
              At <span class="font-bold">EvoStep</span>, we bring you the perfect blend of classic and modern footwear. 
              Our latest collection features the top five shoe trends to keep you stylish and comfortable. 
              Explore the styles that will elevate your look and step up your footwear game with Evo Step.
            </div>
            <div class="text-right text-gray-500 font-semibold text-sm md:text-base">
              22<sup>nd</sup> Jan 2025
            </div>
            <div class="text-center mt-4">
              <a href="./Step Up Your Footwear Game with Latest Trends.php">
                <button
                  type="button"
    ...
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
      ...
      <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          ...
          <div class="my-6">
            ...
            <p class="mt-5 text-gray-600 dark:text-neutral-400 font-nunito">
              Dive deeper into the EvoStep’s Urban Footwear Collection.
            </p>
          </div>
        ...
        <a
          class="group flex flex-col h-full border border-gray-200 hover:border-transparent hover:shadow-lg focus:outline-none focus:border-transparent focus:shadow-lg transition duration-300 rounded-xl p-5 dark:border-neutral-700 dark:hover:border-transparent dark:hover:shadow-black/40 dark:focus:border-transparent dark:focus:shadow-black/40"
          href="./Discover More with EvoSteps.php"
        >
          <div class="aspect-w-16 aspect-h-11">
            <img
              class="w-full object-cover rounded-xl"
              src="../../assets/images/blog06.jpeg"
              alt="Discover more with EvoSteps"
            />
          </div>
          <div class="my-6">
            <h3
