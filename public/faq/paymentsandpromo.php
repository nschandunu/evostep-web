          ...
          >
            ...
            >
              ...
              >
                ...
                We accept major credit cards (Visa, MasterCard, American Express), Bank Transfers or PayPal, Google Pay, Apple Pay and EvoStep gift cards for online purchases.
                </p>
              </div>
            </div>
            ...
            >
              ...
              >
                <p class="text-gray-600 dark:text-neutral-400">
                Yes, you can use an EvoStep gift card to pay for your order during checkout.
                </p>
              </div>
            </div>
            ...
            >
              ...
              >
                <p class="text-gray-600 dark:text-neutral-400">
                Double-check the spelling and expiration date of your promo code. Ensure it applies to the items in your cart and meets any minimum purchase requirements. If issues persist, contact our customer support for assistance.                </p>
              </div>
            </div>
          </div>
        </div>
