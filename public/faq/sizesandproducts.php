          ...
          >
            ...
            >
              ...
              >
                ...
                Yes, we provide a size chart for each product category to help you find the best fit. You can find it on the product page or in the Size Guide section.              </div>
            </div>
            ...
            >
              ...
              >
                <p class="text-gray-600 dark:text-neutral-400">
                Follow the instructions in our detailed Size Guide to measure yourself accurately. This will help you choose the correct size based on your measurements and the product’s fit.
            ...
            >
              ...
              >
                <p class="text-gray-600 dark:text-neutral-400">
                Our products are made from high-quality materials such as cotton, polyester, nylon, and blends, as specified on each product page.
            ...
            >
              ...
              >
                <p class="text-gray-600 dark:text-neutral-400">
                Our shoes are crafted with care and precision, sourced from locations renowned for their craftsmanship and quality. Some of our premium collections are produced in state-of-the-art facilities across the United States, ensuring the highest standards of design and production. For our luxury lines, we partner with skilled artisans in Italy and Portugal, blending traditional techniques with modern innovation. Our everyday wear is made in factories in China and Bangladesh, where we maintain strict oversight to ensure fair labor practices and high-quality production standards. Every pair of shoes reflects our commitment to excellence, style, and ethical manufacturing.
            ...
            >
              ...
              >
                <p class="text-gray-600 dark:text-neutral-400">
                Each product page clearly indicates the availability status near the size selection, showing whether the item is in stock or out of stock. If a product is currently out of stock, you have the option to sign up for notifications and be alerted as soon as it’s back in stock.            </div>
          </div>
        </div>
      </div>
    </div>    
